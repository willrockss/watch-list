    ...
    public static Stream<Arguments> escapeFilenameArgs() {
        return Stream.of(
                ...
                Arguments.of(
                        ...
                        "Терминатор_2:_Судный_день_Terminator_2:_Judgment_Day_(Джеймс_Кэмерон_James_Cameron)_[1991_фантастика_боевик_триллер_AC3_NTSC]_[EXTENDED_REMASTERED]_VO_(Данис_Нурмухам.txt"
                ),
                Arguments.of(
                        ...
                        "Терминатор_2:_Судный_день_Terminator_2:_Judgment_Day_(Джеймс_Кэмерон_James_Cameron)_[1991_фантастика_боевик_триллер_AC3_NTSC]_[EXTENDED_REMASTERED]_VO_(Данис_Нурмухаметов"
                )
        );
    }
